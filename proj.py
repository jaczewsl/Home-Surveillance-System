...
def sendEmail(mess, sub, attachment=[]):
    ...
    msg['Subject'] = sub
    msg['From'] = "jaczewski.lukasz@gmail.com"
    msg['To'] = "jaczewski.lukasz@gmail.com"
    message = mess
    ...
    sender = 'jaczewski.lukasz@gmail.com'
    receivers = ['jaczewski.lukasz@gmail.com']

    user = "jaczewski.lukasz@gmail.com"
    pwd = "gmmaiilPnKg1507"
